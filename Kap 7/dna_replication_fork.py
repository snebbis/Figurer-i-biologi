...
What was changed vs. the original:
  ...
  - Base letters are kept readable (never drawn upside-down).
"""
...
N_DS        = 7      # base PAIRS in the double-stranded "stem"
N_SS        = 9      # bases on each unzipped single-stranded arm
...
FIG_SCALE   = 0.72   # inches per data unit (controls overall figure size)
